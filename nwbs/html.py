...
<body>
    ...
    <div class="header">
        <div class="titles">
            ...
            <h2>MIDWEEK MEETING SCHEDULE</h2>
        </div>
        <div class="line1"></div>
    </div>
    {% else %}
    ...
    <table class="table" style="table-layout: fixed; page-break-after: always">
        ...
        <tr>
            <td class="tdfix"></td>
            <td class="tdfix2"><a class="right nwb-roles">Field Service Group:</a></td>
            <td style="width: 250px;">
                <strong>{{ program["group"].title() }}</strong>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="nwb-roles">
            <a class="nwb-roles">Second Hall</a>
            </td>
        ...
        <tr>
            <td>8:09<i style="color: rgb(126,0,36);">&#9679;</i><strong class="emph">{{ d["concluding_song"] }}</strong></td>
            <td><a class="right nwb-roles">Prayer:</a></td>
